...
public abstract class AndroidTrainingDatabase extends RoomDatabase {
    ...
    public static final AndroidTrainingDatabase initDatabase(Context context) {
        return Room.databaseBuilder(context, AndroidTrainingDatabase.class, DB_NAME).build();
        //return Room.inMemoryDatabaseBuilder(context,AndroidTrainingDatabase.class).build();
        // Database chi luu tren bo nho cache, kill app thi se bi mat
    }
}
